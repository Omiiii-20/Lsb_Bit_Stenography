...
typedef struct _EncodeInfo
{
    ...
    /* Secret File Info */
    char *secret_fname;  //store the name of secret txt file
    ...
    /* Stego Image Info */
    char *stego_image_fname;  //new file name
...
Status read_and_validate_encode_args(char *argv[], EncodeInfo *encInfo);//comp

/* Perform the encoding */
Status do_encoding(EncodeInfo *encInfo);//comp
